...
### Ревью 1.0.1
- [ ] LinkedHashMap - у этой реализации Map есть свойство, которое усложняет структуру и увеличивает используемую память. Посмотри реализацию проще.
- [ ] логика метода filteredByCycles достаточно проста, введение вспомогательных методов не упрощает понимание, а метод addMeal так точно не нужен - добавление записи в Map и никакой логики.
- [ ] префикс table - не несет смысловой нагрузки. Лучше заменить на map/list
- [ ] `ArrayList<MealTo> tableOfMealTo` -
